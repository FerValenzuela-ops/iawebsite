...
sampleX='static/gato.jpg'
sampleY='static/perro.jpg'
...
def uploaded_file(filename):
    ...
    with myGraph.as_default():
        ...
        if result[0] < 0.5 :
            answer = "<div class='col text-center'><img width='150' height='150' src='"+image_src+"' class='img-thumbnail' /><h4>"+X+"</h4></div><div class='col'></div><div class='w-100'></div>"     
        else:
            answer = "<div class='col'></div><div class='col text-center'><img width='150' height='150' src='"+image_src+"' class='img-thumbnail' /><h4>"+Y+"</h4></div><div class='w-100'></div>"     
